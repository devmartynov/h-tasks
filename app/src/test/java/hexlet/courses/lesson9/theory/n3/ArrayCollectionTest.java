package hexlet.courses.lesson9.theory.n3;
...
import hexlet.courses.lessont9.theory.n3.ArrayCollection;
...
public class ArrayCollectionTest {
    ...
    public void testNextInIterator() {
        assertThrows(NoSuchElementException.class, () -> testInstance.iterator().next());
    }
